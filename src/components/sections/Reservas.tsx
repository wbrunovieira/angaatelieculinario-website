    ...
    <section id="reservas" className="on-dark relative z-10 bg-mata text-linho">
      <div className="grid md:grid-cols-12">
        ...
        <div className="px-5 py-20 md:col-span-6 md:col-start-7 md:py-32 md:pr-10">
          ...
          <Reveal
            as="h2"
            className="display mt-6 text-[clamp(2.6rem,5.5vw,5rem)]"
          >
              ...
              {site.hours.map((h) => (
                ...
                >
                  ...
                  <dd className="text-linho/85">
                    {h.time}
                    <span className="block text-sm text-linho/55">
                      {h.label}
                    </span>
                  </dd>
                </div>
          ...
          <Reveal mode="fade" delay={0.6}>
            ...
            <p className="mt-10 max-w-[44ch] text-sm text-linho/60">
              Casamentos, aniversários e celebrações também acontecem aqui, em
              três formatos de festa. Conte pra gente o que você imagina.
            </p>
          </Reveal>
        </div>
      </div>
