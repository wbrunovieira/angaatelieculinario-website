...
export function Reservas() {
  const foto = photos.fogao_lenha_tacho_rapadura;
  const a = site.address;
  return (
    <section id="reservas" className="on-dark bg-mata text-linho">
      <div className="grid md:grid-cols-12">
        <div className="relative aspect-[4/3] md:col-span-5 md:aspect-auto md:min-h-[80vh]">
          <Image
            src={foto.src}
        ...
        <div className="px-5 py-20 md:col-span-6 md:col-start-7 md:py-32 md:pr-10">
          ...
          <h2 className="display mt-6 text-[clamp(2.6rem,5.5vw,5rem)]">
